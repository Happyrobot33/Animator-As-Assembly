...
namespace AnimatorAsCode.V0
{
    public static class AacV0
    {
        ...
        {
            clip.name = suffix + "__zAutogenerated__" + component.AssetKey + "_" + Random.Range(0, Int32.MaxValue); // FIXME animation name conflict
    ...
    public struct AacFlLayer
    {
        ...
        public AacFlState NewState(string name)
        {
            ...
            //var state = _stateMachine.NewState(name, 0, 0);
            return state;
        }
    ...
    public class AacFlBase
    {
        ...
        public void ClearPreviousAssets()
        {
            ...
            {
                if (subAsset != _configuration.AssetContainer
