...
namespace AnimatorAsAssembly.Commands
{
    public class JIGE : OPCODE
    {
        ...
        public JIGE(Register A, Register B, AacFlLayer Layer, ComplexProgressBar progressWindow)
        {
        ...
        /// <param name="Layer"> The FX controller that this command is linked to </param>
        public JIGE(string[] args, AacFlLayer Layer, ComplexProgressBar progressWindow)
        {
        ...
        )
        {
            ...
            this._layer = Layer.NewStateGroup("JIGE");
        ...
        {
            Profiler.BeginSample("JIGE");
            ProgressBar PB = this._progressWindow.RegisterNewProgressBar("JIGE", "");
            yield return PB.SetProgress(0);
            AacFlState entry = _layer.NewState("JIGE");
