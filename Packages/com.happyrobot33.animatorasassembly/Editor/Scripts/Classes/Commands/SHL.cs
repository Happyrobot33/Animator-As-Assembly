...
namespace AnimatorAsAssembly.Commands
{
    public class SHL : OPCODE
    {
        ...
        public SHL(Register A, AacFlLayer Layer, NestedProgressBar progressWindow, int shift = 1)
        {
        ...
        /// <param name="Layer"> The FX controller that this command is linked to </param>
        public SHL(string[] args, AacFlLayer Layer, NestedProgressBar progressWindow)
        {
        ...
        public override IEnumerator<EditorCoroutine> STATES(Action<AacFlState[]> callback)
        {
            ...
            ProgressBar PB = this.progressWindow.registerNewProgressBar("SHL", "");
